...
template <typename T>
FixedPointStruct<T> CreateFixedPointStruct(T fixed_point, std::size_t k, std::size_t f);
...
template <typename T>
FixedPointVectorStruct<T> CreateFixedPointVectorStruct(T fixed_point_mantissa_vector, std::size_t k,
                                                       std::size_t f, std::size_t vector_size = 1);

template <typename T>
FixedPointVectorStruct<T> CreateFixedPointVectorStruct(
    const std::vector<T>& fixed_point_mantissa_vector, std::size_t, std::size_t f);
...
template <typename T, typename T_int = std::make_signed_t<T>>
long double FixedPointToDouble(T fixed_point_struct, std::size_t k, std::size_t f);
...
template <typename T, typename T_int = std::make_signed_t<T>, typename A = std::allocator<T>>
...
template <typename T, typename T_int = std::make_signed_t<T>, typename A = std::allocator<T>>
T FixedPointAppRcr_opt(T b, std::size_t k, std::size_t f);
