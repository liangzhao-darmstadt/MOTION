...
template FixedPointStruct<std::uint8_t> CreateFixedPointStruct<std::uint8_t>(double fixed_point,
                                                                             std::size_t k,
                                                                             std::size_t f);

template FixedPointStruct<std::uint16_t> CreateFixedPointStruct<std::uint16_t>(double fixed_point,
                                                                               std::size_t k,
                                                                               std::size_t f);

template FixedPointStruct<std::uint32_t> CreateFixedPointStruct<std::uint32_t>(double fixed_point,
                                                                               std::size_t k,
                                                                               std::size_t f);
...
template FixedPointVectorStruct<std::uint8_t> CreateFixedPointVectorStruct<std::uint8_t>(
    double fixed_point, std::size_t k, std::size_t f, std::size_t vector_size);

template FixedPointVectorStruct<std::uint16_t> CreateFixedPointVectorStruct<std::uint16_t>(
    double fixed_point, std::size_t k, std::size_t f, std::size_t vector_size);

template FixedPointVectorStruct<std::uint32_t> CreateFixedPointVectorStruct<std::uint32_t>(
    double fixed_point, std::size_t k, std::size_t f, std::size_t vector_size);
...
template <typename T>
std::vector<T> double_to_fixed_point_as_integer(const double coeff[], std::size_t coeff_size, std::size_t k, std::size_t f) {
  std::vector<T> fixed_point_array;
  fixed_point_array.resize(coeff_size);
...
template std::vector<std::uint8_t> double_to_fixed_point_as_integer<std::uint8_t>(const double coeff[], std::size_t coeff_size,
                                              std::size_t k, std::size_t f);

template std::vector<std::uint16_t> double_to_fixed_point_as_integer<std::uint16_t>(const double coeff[], std::size_t coeff_size,
                                               std::size_t k, std::size_t f);

template std::vector<std::uint32_t> double_to_fixed_point_as_integer<std::uint32_t>(const double coeff[], std::size_t coeff_size,
                                               std::size_t k, std::size_t f);

template std::vector<std::uint64_t> double_to_fixed_point_as_integer<std::uint64_t>(const double coeff[], std::size_t coeff_size,
                                               std::size_t k, std::size_t f);

template std::vector<__uint128_t> double_to_fixed_point_as_integer<__uint128_t>(const double coeff[], std::size_t coeff_size,
                                             std::size_t k, std::size_t f);
...
template FixedPointStruct<std::uint8_t> CreateFixedPointStruct<std::uint8_t>(
    std::uint8_t fixed_point_mantissa, std::size_t k, std::size_t f);

template FixedPointStruct<std::uint16_t> CreateFixedPointStruct<std::uint16_t>(
    std::uint16_t fixed_point_mantissa, std::size_t k, std::size_t f);

template FixedPointStruct<std::uint32_t> CreateFixedPointStruct<std::uint32_t>(
    std::uint32_t fixed_point_mantissa, std::size_t k, std::size_t f);
...
template FixedPointVectorStruct<std::uint8_t> CreateFixedPointVectorStruct<std::uint8_t>(
    std::uint8_t fixed_point_mantissa, std::size_t k, std::size_t f, std::size_t vector_size);

template FixedPointVectorStruct<std::uint16_t> CreateFixedPointVectorStruct<std::uint16_t>(
    std::uint16_t fixed_point_mantissa, std::size_t k, std::size_t f, std::size_t vector_size);

template FixedPointVectorStruct<std::uint32_t> CreateFixedPointVectorStruct<std::uint32_t>(
    std::uint32_t fixed_point_mantissa, std::size_t k, std::size_t f, std::size_t vector_size);
...
template FixedPointVectorStruct<std::uint8_t> CreateFixedPointVectorStruct<std::uint8_t>(
    const std::vector<std::uint8_t>& fixed_point_mantissa_vector, std::size_t k, std::size_t f);

template FixedPointVectorStruct<std::uint16_t> CreateFixedPointVectorStruct<std::uint16_t>(
    const std::vector<std::uint16_t>& fixed_point_mantissa_vector, std::size_t k, std::size_t f);

template FixedPointVectorStruct<std::uint32_t> CreateFixedPointVectorStruct<std::uint32_t>(
    const std::vector<std::uint32_t>& fixed_point_mantissa_vector, std::size_t k, std::size_t f);
...
template long double FixedPointToDouble<std::uint8_t, std::int8_t>(
    FixedPointStruct<std::uint8_t> fixed_point_struct);

template long double FixedPointToDouble<std::uint16_t, std::int16_t>(
    FixedPointStruct<std::uint16_t> fixed_point_struct);

template long double FixedPointToDouble<std::uint32_t, std::int32_t>(
    FixedPointStruct<std::uint32_t> fixed_point_struct);
...
template long double FixedPointToDouble<std::uint8_t, std::int8_t>(std::uint8_t fixed_point,
                                                                   std::size_t k, std::size_t f);

template long double FixedPointToDouble<std::uint16_t, std::int16_t>(std::uint16_t fixed_point,
                                                                     std::size_t k, std::size_t f);

template long double FixedPointToDouble<std::uint32_t, std::int32_t>(std::uint32_t fixed_point,
                                                                     std::size_t k, std::size_t f);
...
FixedPointToDouble<__uint8_t, __int8_t, std::allocator<__uint8_t>>(
    std::vector<__uint8_t, std::allocator<__uint8_t>> fixed_point_mantissa_vector, std::size_t k,
    std::size_t f);

template std::vector<long double>
FixedPointToDouble<__uint16_t, __int16_t, std::allocator<__uint16_t>>(
    std::vector<__uint16_t, std::allocator<__uint16_t>> fixed_point_mantissa_vector, std::size_t k,
    std::size_t f);

template std::vector<long double>
FixedPointToDouble<__uint32_t, __int32_t, std::allocator<__uint32_t>>(
    std::vector<__uint32_t, std::allocator<__uint32_t>> fixed_point_mantissa_vector, std::size_t k,
    std::size_t f);
...
template FixedPointStruct<std::uint8_t> FixedPointAddition(
    FixedPointStruct<std::uint8_t>& fixed_point_a, FixedPointStruct<std::uint8_t>& fixed_point_b);

template FixedPointStruct<std::uint16_t> FixedPointAddition(
    FixedPointStruct<std::uint16_t>& fixed_point_a, FixedPointStruct<std::uint16_t>& fixed_point_b);

template FixedPointStruct<std::uint32_t> FixedPointAddition(
    FixedPointStruct<std::uint32_t>& fixed_point_a, FixedPointStruct<std::uint32_t>& fixed_point_b);
...
template FixedPointStruct<std::uint8_t> FixedPointMultiplication<std::uint8_t, std::int8_t>(
    FixedPointStruct<std::uint8_t>& fixed_point_a, FixedPointStruct<std::uint8_t>& fixed_point_b);

template FixedPointStruct<std::uint16_t> FixedPointMultiplication<std::uint16_t, std::int16_t>(
    FixedPointStruct<std::uint16_t>& fixed_point_a, FixedPointStruct<std::uint16_t>& fixed_point_b);

template FixedPointStruct<std::uint32_t> FixedPointMultiplication<std::uint32_t, std::int32_t>(
    FixedPointStruct<std::uint32_t>& fixed_point_a, FixedPointStruct<std::uint32_t>& fixed_point_b);
...
template FixedPointStruct<std::uint8_t> FixedPointDivisionSimple<std::uint8_t, std::int8_t>(
    FixedPointStruct<std::uint8_t>& fixed_point_a, FixedPointStruct<std::uint8_t>& fixed_point_b);

template FixedPointStruct<std::uint16_t> FixedPointDivisionSimple<std::uint16_t, std::int16_t>(
    FixedPointStruct<std::uint16_t>& fixed_point_a, FixedPointStruct<std::uint16_t>& fixed_point_b);

template FixedPointStruct<std::uint32_t> FixedPointDivisionSimple<std::uint32_t, std::int32_t>(
    FixedPointStruct<std::uint32_t>& fixed_point_a, FixedPointStruct<std::uint32_t>& fixed_point_b);
...
FixedPointStruct<T> FixedPointDivision(FixedPointStruct<T>& fixed_point_a,
  ...
  print_u128_u("b: ", b);
  std::cout << "b_double: " << FixedPointToDouble<T, T_int>(b,k,f) << std::endl;
  print_u128_u("w: ", w);
  std::cout << "w_double: " << FixedPointToDouble<T, T_int>(w,k,f) << std::endl;
  //
...
template FixedPointStruct<std::uint8_t>
FixedPointDivision<std::uint8_t, std::int8_t, std::allocator<std::uint8_t>>(
    FixedPointStruct<std::uint8_t>& fixed_point_a, FixedPointStruct<std::uint8_t>& fixed_point_b);

template FixedPointStruct<std::uint16_t>
FixedPointDivision<std::uint16_t, std::int16_t, std::allocator<std::uint16_t>>(
    FixedPointStruct<std::uint16_t>& fixed_point_a, FixedPointStruct<std::uint16_t>& fixed_point_b);

template FixedPointStruct<std::uint32_t>
FixedPointDivision<std::uint32_t, std::int32_t, std::allocator<std::uint32_t>>(
    FixedPointStruct<std::uint32_t>& fixed_point_a, FixedPointStruct<std::uint32_t>& fixed_point_b);

template FixedPointStruct<std::uint64_t>
FixedPointDivision<std::uint64_t, std::int64_t, std::allocator<std::uint64_t>>(
    FixedPointStruct<std::uint64_t>& fixed_point_a, FixedPointStruct<std::uint64_t>& fixed_point_b);
...
template std::uint8_t Pow2<std::uint8_t>(std::uint8_t a, std::size_t k);
template std::uint16_t Pow2<std::uint16_t>(std::uint16_t a, std::size_t k);
template std::uint32_t Pow2<std::uint32_t>(std::uint32_t a, std::size_t k);
template std::uint64_t Pow2<std::uint64_t>(std::uint64_t a, std::size_t k);
...
template std::uint8_t FixedPointAppRcr<std::uint8_t, std::int8_t, std::allocator<std::uint8_t>>(
    std::uint8_t b, std::size_t k, std::size_t f);

template std::uint16_t FixedPointAppRcr<std::uint16_t, std::int16_t, std::allocator<std::uint16_t>>(
    std::uint16_t b, std::size_t k, std::size_t f);

template std::uint32_t FixedPointAppRcr<std::uint32_t, std::int32_t, std::allocator<std::uint32_t>>(
    std::uint32_t b, std::size_t k, std::size_t f);

template std::uint64_t FixedPointAppRcr<std::uint64_t, std::int64_t, std::allocator<std::uint64_t>>(
    std::uint64_t b, std::size_t k, std::size_t f);
...
template std::uint8_t FixedPointAppRcr_opt<std::uint8_t, std::int8_t, std::allocator<std::uint8_t>>(
    std::uint8_t b, std::size_t k, std::size_t f);

template std::uint16_t
FixedPointAppRcr_opt<std::uint16_t, std::int16_t, std::allocator<std::uint16_t>>(std::uint16_t b,
                                                                                 std::size_t k,
                                                                                 std::size_t f);

template std::uint32_t
FixedPointAppRcr_opt<std::uint32_t, std::int32_t, std::allocator<std::uint32_t>>(std::uint32_t b,
                                                                                 std::size_t k,
                                                                                 std::size_t f);

template std::uint64_t
FixedPointAppRcr_opt<std::uint64_t, std::int64_t, std::allocator<std::uint64_t>>(std::uint64_t b,
                                                                                 std::size_t k,
                                                                                 std::size_t f);
...
template std::vector<std::uint8_t, std::allocator<std::uint8_t>>
FixedPointNorm<std::uint8_t, std::int8_t, std::allocator<std::uint8_t>>(std::uint8_t b,
                                                                        std::size_t k,
                                                                        std::size_t f);

template std::vector<std::uint16_t, std::allocator<std::uint16_t>>
FixedPointNorm<std::uint16_t, std::int16_t, std::allocator<std::uint16_t>>(std::uint16_t b,
                                                                           std::size_t k,
                                                                           std::size_t f);

template std::vector<std::uint32_t, std::allocator<std::uint32_t>>
FixedPointNorm<std::uint32_t, std::int32_t, std::allocator<std::uint32_t>>(std::uint32_t b,
                                                                           std::size_t k,
                                                                           std::size_t f);

template std::vector<std::uint64_t, std::allocator<std::uint64_t>>
FixedPointNorm<std::uint64_t, std::int64_t, std::allocator<std::uint64_t>>(std::uint64_t b,
                                                                           std::size_t k,
                                                                           std::size_t f);
...
template std::vector<std::uint8_t, std::allocator<std::uint8_t>>
FixedPointNormSQ<std::uint8_t, std::allocator<std::uint8_t>>(std::uint8_t b, std::size_t k,
                                                             std::size_t f);

template std::vector<std::uint16_t, std::allocator<std::uint16_t>>
FixedPointNormSQ<std::uint16_t, std::allocator<std::uint16_t>>(std::uint16_t b, std::size_t k,
                                                               std::size_t f);

template std::vector<std::uint32_t, std::allocator<std::uint32_t>>
FixedPointNormSQ<std::uint32_t, std::allocator<std::uint32_t>>(std::uint32_t b, std::size_t k,
                                                               std::size_t f);

template std::vector<std::uint64_t, std::allocator<std::uint64_t>>
FixedPointNormSQ<std::uint64_t, std::allocator<std::uint64_t>>(std::uint64_t b, std::size_t k,
                                                               std::size_t f);
...
template std::vector<std::uint8_t, std::allocator<std::uint8_t>>
FixedPointSimplifiedNormSQ<std::uint8_t, std::allocator<std::uint8_t>>(std::uint8_t b,
                                                                       std::size_t k,
                                                                       std::size_t f);

template std::vector<std::uint16_t, std::allocator<std::uint16_t>>
FixedPointSimplifiedNormSQ<std::uint16_t, std::allocator<std::uint16_t>>(std::uint16_t b,
                                                                         std::size_t k,
                                                                         std::size_t f);

template std::vector<std::uint32_t, std::allocator<std::uint32_t>>
FixedPointSimplifiedNormSQ<std::uint32_t, std::allocator<std::uint32_t>>(std::uint32_t b,
                                                                         std::size_t k,
                                                                         std::size_t f);

template std::vector<std::uint64_t, std::allocator<std::uint64_t>>
FixedPointSimplifiedNormSQ<std::uint64_t, std::allocator<std::uint64_t>>(std::uint64_t b,
                                                                         std::size_t k,
                                                                         std::size_t f);
...
template std::uint8_t FixedPointFx2Int<std::uint8_t, std::int8_t>(
    FixedPointStruct<std::uint8_t>& fixed_point_a);

template std::uint16_t FixedPointFx2Int<std::uint16_t, std::int16_t>(
    FixedPointStruct<std::uint16_t>& fixed_point_a);

template std::uint32_t FixedPointFx2Int<std::uint32_t, std::int32_t>(
    FixedPointStruct<std::uint32_t>& fixed_point_a);

template std::uint64_t FixedPointFx2Int<std::uint64_t, std::int64_t>(
    FixedPointStruct<std::uint64_t>& fixed_point_a);
...
template FixedPointStruct<std::uint8_t>
FixedPointParamFxSqrt<std::uint8_t, std::int8_t, std::allocator<std::uint8_t>>(std::uint8_t x,
                                                                               std::size_t k,
                                                                               std::size_t f);

template FixedPointStruct<std::uint16_t>
FixedPointParamFxSqrt<std::uint16_t, std::int16_t, std::allocator<std::uint16_t>>(std::uint16_t x,
                                                                                  std::size_t k,
                                                                                  std::size_t f);

template FixedPointStruct<std::uint32_t>
FixedPointParamFxSqrt<std::uint32_t, std::int32_t, std::allocator<std::uint32_t>>(std::uint32_t x,
                                                                                  std::size_t k,
                                                                                  std::size_t f);

template FixedPointStruct<std::uint64_t>
FixedPointParamFxSqrt<std::uint64_t, std::int64_t, std::allocator<std::uint64_t>>(std::uint64_t x,
                                                                                  std::size_t k,
                                                                                  std::size_t f);
...
template FixedPointStruct<std::uint8_t>
FixedPointSimplifiedFxSqrt<std::uint8_t, std::int8_t, std::allocator<std::uint8_t>>(std::uint8_t x,
                                                                                    std::size_t k,
                                                                                    std::size_t f);

template FixedPointStruct<std::uint16_t>
FixedPointSimplifiedFxSqrt<std::uint16_t, std::int16_t, std::allocator<std::uint16_t>>(
    std::uint16_t x, std::size_t k, std::size_t f);

template FixedPointStruct<std::uint32_t>
FixedPointSimplifiedFxSqrt<std::uint32_t, std::int32_t, std::allocator<std::uint32_t>>(
    std::uint32_t x, std::size_t k, std::size_t f);

template FixedPointStruct<std::uint64_t>
FixedPointSimplifiedFxSqrt<std::uint64_t, std::int64_t, std::allocator<std::uint64_t>>(
    std::uint64_t x, std::size_t k, std::size_t f);
...
template std::uint8_t FixedPointLinAppSQ<std::uint8_t, std::int8_t, std::allocator<std::uint8_t>>(
    std::uint8_t b, std::size_t k, std::size_t f);

template std::uint16_t
FixedPointLinAppSQ<std::uint16_t, std::int16_t, std::allocator<std::uint16_t>>(std::uint16_t b,
                                                                               std::size_t k,
                                                                               std::size_t f);
template std::uint32_t
FixedPointLinAppSQ<std::uint32_t, std::int32_t, std::allocator<std::uint32_t>>(std::uint32_t b,
                                                                               std::size_t k,
                                                                               std::size_t f);
...
template FixedPointStruct<std::uint8_t>
FixedPointExp2P1045<std::uint8_t, std::int8_t, std::allocator<std::uint8_t>>(
    FixedPointStruct<std::uint8_t>& fixed_point_a);

template FixedPointStruct<std::uint16_t>
FixedPointExp2P1045<std::uint16_t, std::int16_t, std::allocator<std::uint16_t>>(
    FixedPointStruct<std::uint16_t>& fixed_point_a);

template FixedPointStruct<std::uint32_t>
FixedPointExp2P1045<std::uint32_t, std::int32_t, std::allocator<std::uint32_t>>(
    FixedPointStruct<std::uint32_t>& fixed_point_a);

template FixedPointStruct<std::uint64_t>
FixedPointExp2P1045<std::uint64_t, std::int64_t, std::allocator<std::uint64_t>>(
    FixedPointStruct<std::uint64_t>& fixed_point_a);
...
template FixedPointStruct<std::uint8_t> FixedPointPolynomialEvaluation<std::uint8_t, std::int8_t>(
    FixedPointStruct<std::uint8_t>& fixed_point_x, const double coefficient[],
    std::size_t array_size);

template FixedPointStruct<std::uint16_t> FixedPointPolynomialEvaluation<
    std::uint16_t, std::int16_t>(FixedPointStruct<std::uint16_t>& fixed_point_x,
                                 const double coefficient[], std::size_t array_size);

template FixedPointStruct<std::uint32_t> FixedPointPolynomialEvaluation<
    std::uint32_t, std::int32_t>(FixedPointStruct<std::uint32_t>& fixed_point_x,
                                 const double coefficient[], std::size_t array_size);

template FixedPointStruct<std::uint64_t> FixedPointPolynomialEvaluation<
    std::uint64_t, std::int64_t>(FixedPointStruct<std::uint64_t>& fixed_point_x,
                                 const double coefficient[], std::size_t array_size);
...
FixedPointStruct<FLType> FixedPointLog2PQ2524(FixedPointStruct<FLType>& fixed_point_a) {
  ...
  std::cout << "constant_p_plus_k_minus_1: "
            << FixedPointToDouble<IntType, IntType_int>(constant_p_plus_k_minus_1,k,f) << std::endl;
...
void test_fixed_point_operation() {
  ...
  double fixed_point_a_double = FixedPointToDouble<FxType, FxType_int>(fixed_point_a, k, f);
  std::cout << "fixed_point_a_double: " << fixed_point_a_double << std::endl;
  FixedPointStruct<FxType> fixed_point_a_struct = CreateFixedPointStruct<FxType>(fixed_point_a,k,f);
